...
export default function Swap({ history }: RouteComponentProps) {
  ...
  const outputCurrencyAddress = urlLoadedTokens[0].address

  const tokenData = useTokenData(outputCurrencyAddress)
  const transactions = useTokenTransactions(outputCurrencyAddress)

  console.log("pooh, urlLoadedTokens = ", urlLoadedTokens[0].address)
